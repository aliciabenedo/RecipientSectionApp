...
public class RecipientDashboard extends javax.swing.JFrame {
    ...
    public RecipientDashboard() {
        ...
        availableDonations.add(new FoodDonation("Bread", 1, "2024-12-01"));
        availableDonations.add(new FoodDonation("Milk", 5, "2024-12-20"));
        availableDonations.add(new FoodDonation("egg", 3, "2024-12-18"));
        availableDonations.add(new FoodDonation("donut", 5, "2024-12-11"));
        availableDonations.add(new FoodDonation("butter", 2, "2024-12-28"));
        availableDonations.add(new FoodDonation("cake", 4, "2024-12-16"));        
        availableDonations.add(new FoodDonation("Rice", 5, "2024-12-15"));
    }
    ...
    private void claimDonationsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_claimDonationsActionPerformed
        ...
        FoodDonation donation = availableDonations.get(0); 

        donation.reduceQuantity(); 

        if (donation.isDepleted()) {
            availableDonations.remove(0); 
            JOptionPane.showMessageDialog(this, donation.getFoodType() + " has been fully claimed.");
        } else {
            JOptionPane.showMessageDialog(this, "Claimed 1 unit of " + donation.getFoodType() + ". Remaining: " + donation.getQuantity());
        }
